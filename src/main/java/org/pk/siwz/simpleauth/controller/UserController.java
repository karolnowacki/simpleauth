package org.pk.siwz.simpleauth.controller;

import lombok.extern.slf4j.Slf4j;
import org.pk.siwz.simpleauth.data.UserRepository;
import org.pk.siwz.simpleauth.data.model.User;
import org.pk.siwz.simpleauth.errors.EntityNotFoundException;
...
class UserController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("!hasAuthority('USER') || (authentication.principal == @userRepository.findById(#id).orElse(new org.pk.siwz.simpleauth.data.model.User()).email)")
